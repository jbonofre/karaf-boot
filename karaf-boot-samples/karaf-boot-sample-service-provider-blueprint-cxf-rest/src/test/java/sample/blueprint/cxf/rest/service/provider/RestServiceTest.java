...
public class RestServiceTest {
    ...
    public static Option[] configure() throws Exception {
        return new Option[]{
                ...
                mavenBundle().groupId("org.apache.karaf.boot").artifactId("karaf-boot-sample-service-provider-blueprint-api").version("1.0.0-SNAPSHOT"),
                mavenBundle().groupId("org.apache.karaf.boot").artifactId("karaf-boot-sample-service-provider-blueprint-cxf-rest").version("1.0.0-SNAPSHOT"),
                keepRuntimeFolder()
        };
    }
